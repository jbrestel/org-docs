...
* Phase 2 (organism vs dataset; genomic sites)
   ...
   + Additional modeifications after UX 07.07.21 meeting
     ...
     [ ] Change any instance of previous genomes page category (Annotation...) to new category (Genomics)
     [ ] External Databases Associated table: Rename table, and incorporate links (chop off everything after "/###ID###"?)
     [ ] Explore Other Categories of Data table: hotlink number instead of category name (the Genomics line will be removed after above changes)
